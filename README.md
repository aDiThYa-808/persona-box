...
## Explore The Project
 For detailed information of each layer, see the respective folder READMEs: <br>
 - **Client**: [client/README.md](./client/README.md) <br>
 - **Server**: [server/README.md](./server/README.md) 

## Contributing
This project is primarily maintained by me. If you’re interested in contributing or discussing ideas, please reach out first so we can coordinate:
 [contactadiiiii@gmail.com](mailto:contactadiiiii@gmail.com)   
